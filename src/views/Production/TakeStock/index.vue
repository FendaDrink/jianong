<template>
  ...
  <h1 style="font-size: 28px;margin-bottom: 20px">生产基地物资盘点</h1>
...
import {getPurInventory ,productionUpdateInventory} from "@/request/production";
...
const update= async (key:string) => {
  try{
    let res = await productionUpdateInventory(editableData[key]);
