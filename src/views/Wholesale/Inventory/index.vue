<template>
  ...
  <h1 style="font-size: 28px;margin-bottom: 20px">批发中心产品盘点</h1>
...
import {getProductStock ,wholesaleUpdatestock} from "@/request/api";
...
const update= async (key:string) => {
  try{
    let res = await wholesaleUpdatestock(editableData[key]);
